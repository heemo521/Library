...
const displayBook = function (books) {
    ...
    books.forEach((book) => {
        ...
        const bookHtml = `
                ...
                <div class="book-top">
                    <h3 class="title"><a href="#" class="btn btn-edit">${title}</a></h3>
                </div>
...
// const reOpenForm = function (event) {
//     event.target
//     setFormValues(book);
//     openForm();
// };
...
const setFormValues = function (book) {
    title.value = book.title;
    firstName.value = book.firstName;
    lastName.value = book.lastName;
    date.value = book.date;
    pages.value = book.pages;
    comments.value = book.comments;
    genre.value = book.genre;

    // how to set radio button checked from javascript
};
